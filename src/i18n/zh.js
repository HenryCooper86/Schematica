...
export default {
  ...
  "Interface worklist": "接口工作清单",
  "Choose a connection to edit. Reuse fills blank connection fields on selected wires of the same bus; endpoint capabilities stay with each part.": "选择要编辑的连接。复用仅填充所选同类总线连接的空白字段；端点能力仍由各部件分别声明。",
  "Checked": "已检查",
  "Failed": "失败",
  "Unassessed": "未评估",
  "Not applicable": "不适用",
  "Reuse target": "复用目标",
  "Preview reuse from selected connection": "预览从所选连接复用",
  "Only these blank connection fields will be filled:": "仅填充以下空白连接字段：",
  "Apply reuse": "应用复用",
  "The selected connections have no blank fields to reuse.": "所选连接没有可复用的空白字段。",
  "Choose a declared interface source.": "请选择已有声明的接口作为来源。",
  "Choose at least one target connection.": "请至少选择一条目标连接。",
  "Targets must be different connections on the same bus.": "目标必须是同类总线上的其他连接。",
  "Reused fields would make a target interface incompatible.": "复用的字段会使目标接口不兼容。",
};
