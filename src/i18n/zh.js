...
export default {
  ...
  'One part on this rail declares no current, so the {draw} total leaves it out.': '该电压轨上有 1 个部件未声明电流，因此 {draw} 的合计未将其计入。',
  '{n} parts on this rail declare no current, so the {draw} total leaves them out.': '该电压轨上有 {n} 个部件未声明电流，因此 {draw} 的合计未将它们计入。',
