...
export const EXAMPLES = [
  ...
  },
  {
    ...
    doc: {
      ...
      nodes: [
        { id: 't1', kind: 'insider', x: 60, y: 80, label: 'Rogue engineer', sublabel: 'insider', color: null, addr: '', rail: '', notes: 'Could push an unsigned build if signing keys were shared.', status: null, flags: [] },
        { id: 't2', kind: 'threatactor', x: 60, y: 230, label: 'Adversary', sublabel: 'on-path', color: null, addr: '', rail: '', notes: 'Tries to swap the image between the CDN and the vehicle.', status: null, flags: [] },
        { id: 't3', kind: 'malware', x: 60, y: 470, label: 'Trojan image', sublabel: 'implant', color: null, addr: '', rail: '', notes: 'A tampered bundle fails the signature check on the device.', status: null, flags: [] },
        { id: 'c1', kind: 'server', x: 260, y: 80, label: 'Build server', sublabel: 'CI + signing', color: null, addr: '', rail: '', notes: 'Every image is signed with the release key in an HSM.', status: 'production', flags: ['safety'] },
        { id: 'c2', kind: 'apigateway', x: 400, y: 80, label: 'Update API', sublabel: 'mTLS', color: null, addr: '', rail: '', notes: '', status: 'production', flags: [] },
        { id: 'c3', kind: 'waf', x: 540, y: 80, label: 'WAF', sublabel: '', color: null, addr: '', rail: '', notes: '', status: 'production', flags: [] },
        { id: 'c4', kind: 'cdn', x: 680, y: 80, label: 'Image CDN', sublabel: 'signed bundles', color: null, addr: '', rail: '', notes: '', status: 'production', flags: [] },
      ...
      wires: [
        ...
        { id: 'w4', bus: 'eth', from: { node: 'c4', port: 'e' }, to: { node: 'net', port: 'w' }, label: 'signed image', arrow: 'fwd', style: null, flow: 'on' },
        { id: 'w5', bus: 'eth', from: { node: 'net', port: 's' }, to: { node: 'v1', port: 'wan' }, label: 'HTTPS', arrow: 'fwd', style: null, flow: 'on' },
  ...
  },
  {
    ...
    doc: {
      ...
      title: 'ADAS Security',
      nodes: [
        { id: 't1', kind: 'threatactor', x: 60, y: 60, label: 'Sensor spoofer', sublabel: 'GNSS / camera', color: null, addr: '', rail: '', notes: 'Fake GNSS signals and projected images against the perception stack.', status: null, flags: [] },
        ...
        { id: 'n3', kind: 'obd', x: 880, y: 450, label: 'OBD-II port', sublabel: 'diagnostics', color: null, addr: '', rail: '', notes: '', status: 'production', flags: [] },
        { id: 't3', kind: 'malware', x: 1060, y: 60, label: 'Infotainment RAT', sublabel: 'implant', color: null, addr: '', rail: '', notes: 'Pivots from the connected head unit toward the vehicle network.', status: null, flags: [] },
        { id: 't4', kind: 'c2', x: 1060, y: 190, label: 'C2 server', sublabel: '', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
        { id: 't2', kind: 'threatactor', x: 1060, y: 450, label: 'CAN injector', sublabel: 'via OBD-II', color: null, addr: '', rail: '', notes: 'A dongle on the diagnostic port injects control frames.', status: null, flags: [] },
      ...
      wires: [
        ...
        { id: 'w14', bus: 'link', from: { node: 'n4', port: 'eth' }, to: { node: 't4', port: 'w' }, label: 'beacons', arrow: 'fwd', style: 'dotted', flow: 'on' },
      ...
      zones: [
        ...
        { id: 'z5', x: 1040, y: 20, w: 190, h: 540, label: 'Network threats', color: '#f87171' },
