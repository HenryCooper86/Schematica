...
export const EXAMPLES = [
  {
    ...
    doc: {
      ...
      wires: [
        { id: 'w1', bus: 'power', from: { node: 'n1', port: 'out' }, to: { node: 'n2', port: 'in' }, label: '', arrow: null, style: null },
        { id: 'w2', bus: 'power', from: { node: 'n2', port: 'bat' }, to: { node: 'n3', port: 'out' }, label: '', arrow: null, style: null },
        { id: 'w3', bus: 'power', from: { node: 'n2', port: 'out' }, to: { node: 'n4', port: 'in' }, label: '', arrow: null, style: null },
        { id: 'w4', bus: 'power', from: { node: 'n4', port: 'out' }, to: { node: 'n5', port: 'vcc' }, label: '3V3', arrow: null, style: null },
        { id: 'w5', bus: 'gnd', from: { node: 'n4', port: 'gnd' }, to: { node: 'n5', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w6', bus: 'i2c', from: { node: 'n5', port: 'i2c' }, to: { node: 'n6', port: 'i2c' }, label: '', arrow: null, style: null },
        { id: 'w7', bus: 'adc', from: { node: 'n5', port: 'adc' }, to: { node: 'n7', port: 'out' }, label: '', arrow: null, style: null },
        { id: 'w8', bus: 'spi', from: { node: 'n5', port: 'spi' }, to: { node: 'n8', port: 'spi' }, label: '', arrow: null, style: null },
      ],
      zones: [
  ...
  },
  {
    ...
    doc: {
      ...
      wires: [
        { id: 'w1', bus: 'power', from: { node: 'n1', port: 'out' }, to: { node: 'n2', port: 'in' }, label: '', arrow: null, style: null },
        { id: 'w2', bus: 'power', from: { node: 'n2', port: 'out' }, to: { node: 'n3', port: 'vcc' }, label: '5V', arrow: null, style: null },
        { id: 'w3', bus: 'gnd', from: { node: 'n2', port: 'gnd' }, to: { node: 'n3', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w4', bus: 'i2c', from: { node: 'n3', port: 'i2c' }, to: { node: 'n4', port: 'i2c' }, label: '', arrow: null, style: null },
        { id: 'w5', bus: 'uart', from: { node: 'n3', port: 'uart' }, to: { node: 'n5', port: 'uart' }, label: '', arrow: null, style: null },
        { id: 'w6', bus: 'pwm', from: { node: 'n3', port: 'pwm' }, to: { node: 'n6', port: 'pwm' }, label: '', arrow: null, style: null },
        { id: 'w7', bus: 'pwm', from: { node: 'n3', port: 'gpio1' }, to: { node: 'n7', port: 'pwm' }, label: '', arrow: null, style: null },
      ],
      zones: [
  ...
  },
  {
    ...
    doc: {
      ...
      wires: [
        { id: 'w1', bus: 'can', from: { node: 'n1', port: 'can' }, to: { node: 'n2', port: 'mcu' }, label: 'TX/RX', arrow: null, style: null },
        { id: 'w2', bus: 'can', from: { node: 'n3', port: 'can' }, to: { node: 'n4', port: 'mcu' }, label: 'TX/RX', arrow: null, style: null },
        { id: 'w3', bus: 'can', from: { node: 'n5', port: 'can' }, to: { node: 'n6', port: 'mcu' }, label: 'TX/RX', arrow: null, style: null },
        { id: 'w4', bus: 'can', from: { node: 'n2', port: 'bus' }, to: { node: 'n4', port: 'bus' }, label: 'CAN H/L', arrow: null, style: null },
        { id: 'w5', bus: 'can', from: { node: 'n4', port: 'bus' }, to: { node: 'n6', port: 'bus' }, label: 'CAN H/L', arrow: null, style: null },
      ],
      zones: [
  ...
  },
  {
    ...
    doc: {
      ...
      wires: [
        { id: 'w1', bus: 'i2c', from: { node: 'n5', port: 'i2c' }, to: { node: 'n1', port: 'i2c' }, label: '', arrow: null, style: null },
        { id: 'w2', bus: 'adc', from: { node: 'n5', port: 'adc' }, to: { node: 'n2', port: 'out' }, label: '', arrow: null, style: null },
        { id: 'w3', bus: 'power', from: { node: 'n3', port: 'out' }, to: { node: 'n4', port: 'in' }, label: '', arrow: null, style: null },
        { id: 'w4', bus: 'power', from: { node: 'n4', port: 'out' }, to: { node: 'n5', port: 'vcc' }, label: '3V3', arrow: null, style: null },
        { id: 'w5', bus: 'gnd', from: { node: 'n4', port: 'gnd' }, to: { node: 'n5', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w6', bus: 'spi', from: { node: 'n5', port: 'spi' }, to: { node: 'n6', port: 'spi' }, label: '', arrow: null, style: null },
        { id: 'w7', bus: 'rf', from: { node: 'n6', port: 'ant' }, to: { node: 'n7', port: 'rf' }, label: '868 MHz', arrow: null, style: null },
        { id: 'w8', bus: 'eth', from: { node: 'n7', port: 'wan' }, to: { node: 'n8', port: 'net' }, label: '', arrow: null, style: null },
        { id: 'w9', bus: 'eth', from: { node: 'n9', port: 'net' }, to: { node: 'n8', port: 'net' }, label: '', arrow: null, style: null },
        { id: 'w10', bus: 'eth', from: { node: 'n9', port: 'db' }, to: { node: 'n10', port: 'net' }, label: '', arrow: null, style: null },
        { id: 'w11', bus: 'rf', from: { node: 'n11', port: 'ble' }, to: { node: 'n8', port: 'rf' }, label: 'push', arrow: null, style: null },
      ],
      zones: [
  ...
  },
  {
    ...
    doc: {
      ...
      wires: [
        { id: 'w1', bus: 'power', from: { node: 'n1', port: 'out' }, to: { node: 'n2', port: 'in' }, label: '', arrow: null, style: null },
        { id: 'w2', bus: 'power', from: { node: 'n2', port: 'out' }, to: { node: 'n4', port: 'vcc' }, label: '5V', arrow: null, style: null },
        { id: 'w3', bus: 'gnd', from: { node: 'n2', port: 'gnd' }, to: { node: 'n4', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w4', bus: 'usb', from: { node: 'n3', port: 'usb' }, to: { node: 'n4', port: 'usb' }, label: 'CDC', arrow: null, style: null },
        { id: 'w5', bus: 'pwm', from: { node: 'n4', port: 'pwm' }, to: { node: 'n5', port: 'pwm' }, label: '', arrow: null, style: null },
        { id: 'w6', bus: 'pwm', from: { node: 'n4', port: 'gpio1' }, to: { node: 'n6', port: 'pwm' }, label: '', arrow: null, style: null },
        { id: 'w7', bus: 'pwm', from: { node: 'n4', port: 'gpio2' }, to: { node: 'n7', port: 'pwm' }, label: '', arrow: null, style: null },
        { id: 'w8', bus: 'i2c', from: { node: 'n4', port: 'i2c' }, to: { node: 'n8', port: 'i2c' }, label: '', arrow: null, style: null },
      ],
      zones: [
  ...
  },
  {
    ...
    doc: {
      ...
      wires: [
        ...
        { id: 'w2', bus: 'power', from: { node: 'n2', port: 'out' }, to: { node: 'n3', port: 'vcc' }, label: '5V', arrow: null, style: null },
        { id: 'w3', bus: 'gnd', from: { node: 'n2', port: 'gnd' }, to: { node: 'n3', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w4', bus: 'power', from: { node: 'n2', port: 'out' }, to: { node: 'n4', port: 'vcc' }, label: '', arrow: null, style: null },
        { id: 'w5', bus: 'gnd', from: { node: 'n2', port: 'gnd' }, to: { node: 'n4', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w6', bus: 'gpio', from: { node: 'n3', port: 'gpio1' }, to: { node: 'n4', port: 'step' }, label: 'STEP', arrow: 'fwd', style: null },
        { id: 'w7', bus: 'gpio', from: { node: 'n3', port: 'gpio2' }, to: { node: 'n4', port: 'dir' }, label: 'DIR', arrow: 'fwd', style: null },
        { id: 'w8', bus: 'i2c', from: { node: 'n3', port: 'i2c' }, to: { node: 'n5', port: 'i2c' }, label: '', arrow: null, style: null },
        { id: 'w9', bus: 'uart', from: { node: 'n3', port: 'uart' }, to: { node: 'n6', port: 'uart' }, label: '115200', arrow: null, style: null },
        { id: 'w10', bus: 'gpio', from: { node: 'n7', port: 'out' }, to: { node: 'n3', port: 'pwm' }, label: 'IRQ', arrow: 'fwd', style: null },
      ],
      zones: [
  ...
  },
  {
    ...
    doc: {
      ...
      wires: [
        { id: 'w1', bus: 'power', from: { node: 'n1', port: 'out' }, to: { node: 'n2', port: 'in' }, label: '12V', arrow: null, style: null },
        { id: 'w2', bus: 'power', from: { node: 'n2', port: 'out1' }, to: { node: 'n4', port: 'vcc' }, label: 'F1', arrow: null, style: null },
        { id: 'w3', bus: 'power', from: { node: 'n2', port: 'out2' }, to: { node: 'n5', port: 'vcc' }, label: 'F2', arrow: null, style: null },
        { id: 'w4', bus: 'power', from: { node: 'n2', port: 'out3' }, to: { node: 'n6', port: 'vcc' }, label: 'F3', arrow: null, style: null },
        { id: 'w5', bus: 'gnd', from: { node: 'n1', port: 'gnd' }, to: { node: 'n4', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w6', bus: 'gnd', from: { node: 'n1', port: 'gnd' }, to: { node: 'n6', port: 'gnd' }, label: '', arrow: null, style: null },
        { id: 'w7', bus: 'can', from: { node: 'n4', port: 'can' }, to: { node: 'n7', port: 'mcu' }, label: 'TX/RX', arrow: null, style: null },
        { id: 'w8', bus: 'can', from: { node: 'n6', port: 'can' }, to: { node: 'n8', port: 'mcu' }, label: 'TX/RX', arrow: null, style: null },
        { id: 'w9', bus: 'can', from: { node: 'n7', port: 'bus' }, to: { node: 'n8', port: 'bus' }, label: 'CAN H/L', arrow: 'both', style: null },
        { id: 'w10', bus: 'can', from: { node: 'n10', port: 'can' }, to: { node: 'n8', port: 'bus' }, label: 'diag tap', arrow: null, style: 'dashed' },
        { id: 'w11', bus: 'adc', from: { node: 'n3', port: 'out' }, to: { node: 'n4', port: 'adc' }, label: '', arrow: 'fwd', style: null },
        { id: 'w12', bus: 'pwm', from: { node: 'n4', port: 'pwm' }, to: { node: 'n5', port: 'in1' }, label: '', arrow: 'fwd', style: null },
        { id: 'w13', bus: 'power', from: { node: 'n5', port: 'out' }, to: { node: 'n9', port: 'vcc' }, label: '', arrow: 'fwd', style: null },
        { id: 'w14', bus: 'uart', from: { node: 'n6', port: 'uart' }, to: { node: 'n11', port: 'mcu' }, label: '', arrow: null, style: null },
        { id: 'w15', bus: 'gpio', from: { node: 'n11', port: 'bus' }, to: { node: 'n12', port: 'io1' }, label: 'LIN', arrow: null, style: 'dashed' },
      ],
      zones: [
