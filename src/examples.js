...
export const EXAMPLES = [
  ...
  },
  {
    ...
    name: 'Corporate Network & Threats (net_draw)',
    doc: {
      schema: 1,
      title: 'Corporate Network',
      nodes: [
        { id: 'n1', kind: 'internet', x: 428, y: 23, label: 'Internet', sublabel: '', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
        { id: 'n2', kind: 'firewall', x: 424, y: 160, label: 'Edge Firewall', sublabel: 'fw-edge-01', color: null, addr: '203.0.113.1', rail: '', notes: 'Under volumetric DDoS from the Mirai botnet.', status: 'production', flags: ['safety'] },
        { id: 'n3', kind: 'router', x: 428, y: 322, label: 'Core Router', sublabel: '', color: null, addr: '10.0.0.1', rail: '', notes: '', status: 'production', flags: [] },
        { id: 'n4', kind: 'switch', x: 428, y: 452, label: 'Core Switch', sublabel: 'core-sw-01', color: null, addr: '', rail: '', notes: '', status: 'production', flags: [] },
        { id: 'n5', kind: 'server', x: 120, y: 600, label: 'Web Server', sublabel: 'web01.corp.local', color: null, addr: '10.0.20.11', rail: '', notes: '', status: 'production', flags: [] },
        { id: 'n6', kind: 'database', x: 368, y: 612, label: 'PostgreSQL', sublabel: '', color: null, addr: '10.0.20.21', rail: '', notes: '', status: 'production', flags: [] },
        { id: 'n7', kind: 'server', x: 588, y: 613, label: 'NAS', sublabel: '', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
        { id: 'n8', kind: 'accesspoint', x: 848, y: 523, label: 'Office AP', sublabel: '', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
        { id: 'n9', kind: 'hostpc', x: 938, y: 673, label: 'Laptop', sublabel: '', color: null, addr: '', rail: '', notes: 'Targeted by the invoice lure.', status: null, flags: [] },
        { id: 'n10', kind: 'hostpc', x: 648, y: 763, label: 'Workstation', sublabel: '', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
        { id: 'n11', kind: 'threatactor', x: 88, y: 27, label: 'APT-29', sublabel: 'nation-state', color: null, addr: '', rail: '', notes: 'STIX: nation-state, sophistication advanced.', status: null, flags: [] },
        { id: 'n12', kind: 'botnet', x: 87, y: 167, label: 'Mirai Botnet', sublabel: 'Mirai', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
        { id: 'n13', kind: 'phishing', x: 713, y: 37, label: 'Invoice Lure', sublabel: 'Q3 invoice lure', color: null, addr: '', rail: '', notes: '', status: null, flags: [] },
      ],
      wires: [
        { id: 'w1', bus: 'eth', from: { node: 'n1', port: 's' }, to: { node: 'n2', port: 'n' }, label: 'WAN', arrow: 'both', style: null, flow: 'on' },
        { id: 'w2', bus: 'eth', from: { node: 'n2', port: 's' }, to: { node: 'n3', port: 'n' }, label: '', arrow: null, style: null, flow: null },
        { id: 'w3', bus: 'eth', from: { node: 'n3', port: 's' }, to: { node: 'n4', port: 'n' }, label: '10 GbE', arrow: null, style: null, flow: null },
        { id: 'w4', bus: 'eth', from: { node: 'n4', port: 's' }, to: { node: 'n5', port: 'net' }, label: '', arrow: null, style: null, flow: null },
        { id: 'w5', bus: 'eth', from: { node: 'n4', port: 's' }, to: { node: 'n6', port: 'net' }, label: '', arrow: null, style: null, flow: null },
        { id: 'w6', bus: 'eth', from: { node: 'n4', port: 's' }, to: { node: 'n7', port: 'net' }, label: '', arrow: null, style: null, flow: null },
        { id: 'w7', bus: 'eth', from: { node: 'n4', port: 'e' }, to: { node: 'n8', port: 'w' }, label: '', arrow: null, style: null, flow: null },
        { id: 'w8', bus: 'rf', from: { node: 'n8', port: 'rf' }, to: { node: 'n9', port: 'eth' }, label: '802.11ax', arrow: null, style: 'dashed', flow: null },
        { id: 'w9', bus: 'eth', from: { node: 'n4', port: 's' }, to: { node: 'n10', port: 'eth' }, label: '', arrow: null, style: null, flow: null },
        { id: 'w10', bus: 'link', from: { node: 'n11', port: 's' }, to: { node: 'n12', port: 'n' }, label: 'controls', arrow: 'fwd', style: 'dotted', flow: null },
        { id: 'w11', bus: 'link', from: { node: 'n12', port: 'e' }, to: { node: 'n2', port: 'w' }, label: 'DDoS', arrow: 'fwd', style: 'dashed', flow: 'on' },
        { id: 'w12', bus: 'link', from: { node: 'n11', port: 'e' }, to: { node: 'n13', port: 'w' }, label: 'sends', arrow: 'fwd', style: 'dotted', flow: null },
        { id: 'w13', bus: 'link', from: { node: 'n13', port: 's' }, to: { node: 'n9', port: 'eth' }, label: 'targets', arrow: 'fwd', style: 'dashed', flow: null },
      ],
      zones: [
        { id: 'z1', x: 356, y: 150, w: 250, h: 130, label: 'DMZ', color: '#f87171' },
        { id: 'z2', x: 350, y: 300, w: 260, h: 250, label: 'Core — 10.0.0.0/16', color: '#60a5fa' },
        { id: 'z3', x: 60, y: 580, w: 700, h: 160, label: 'Servers — VLAN 20', color: '#34d399' },
        { id: 'z4', x: 800, y: 490, w: 290, h: 290, label: 'Wireless', color: '#c084fc' },
      ],
      notes: [
        { id: 't1', x: 960, y: 60, text: 'Ported from net_draw: perimeter, core, servers, and the actors probing them.' },
      ],
      journey: [
        {
          id: 'j1', label: 'Perimeter', view: { cx: 480, cy: 180, zoom: 1.05 },
          caption: 'The Internet reaches the edge firewall over the WAN link; a botnet hammers the same edge.',
        },
        {
          id: 'j2', label: 'Core and servers', view: { cx: 480, cy: 520, zoom: 0.95 },
          caption: 'Router and core switch fan out to the server VLAN and the office wireless.',
        },
        {
          id: 'j3', label: 'Threats', view: { cx: 400, cy: 130, zoom: 1 },
          caption: 'APT-29 controls the botnet and sends an invoice lure that targets a laptop on the Wi-Fi.',
        },
      ],
    },
  },
