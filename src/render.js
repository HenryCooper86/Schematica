...
import { flowOffset, pulseOpacity, blinkOpacity, footstepPoint, stepFootsteps } from './render-animation.js';
export { LOOP_MS, flowOffset, bakeFrame } from './render-animation.js';
