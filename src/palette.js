...
export const PARTS = {
  ...
  // Robotics
  stepper: part('stepper', 'robotics', 'Stepper + driver', 150, 80,
    'M8 8m-5.5 0a5.5 5.5 0 1 0 11 0a5.5 5.5 0 1 0-11 0 M8 8m-1.5 0a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0 M8 2.5v2 M8 11.5v2 M2.5 8h2 M11.5 8h2 M4.1 4.1l1.4 1.4 M10.5 10.5l1.4 1.4 M11.9 4.1l-1.4 1.4 M5.5 10.5l-1.4 1.4',
    [...pwr('top'), p('step', 'STEP', 'left', 0.35, 'gpio'), p('dir', 'DIR', 'left', 0.7, 'gpio')]),
  encoder: part('encoder', 'robotics', 'Encoder', 130, 65,
    'M8 8m-5.5 0a5.5 5.5 0 1 0 11 0a5.5 5.5 0 1 0-11 0 M8 2.5v2.5 M8 11v2.5 M2.5 8h2.5 M11 8h2.5 M8 8m-1 0a1 1 0 1 0 2 0a1 1 0 1 0-2 0',
    [...pwr(), p('a', 'A', 'right', 0.35, 'gpio'), p('b', 'B', 'right', 0.7, 'gpio')]),
  lidar: part('lidar', 'robotics', 'LiDAR', 140, 75,
    'M8 8m-2 0a2 2 0 1 0 4 0a2 2 0 1 0-4 0 M8 8 14 4 M10 2.5a6 6 0 0 1 3.5 3 M8 8 2 12 M4.5 13.5a6 6 0 0 1-2.4-3.7',
    [...pwr(), p('uart', 'UART', 'right', 0.5, 'uart')]),
  ultrasonic: part('ultrasonic', 'robotics', 'Ultrasonic', 140, 70,
    'M5 8m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0 M11 8m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0 M2 3h12v10H2z',
    [...pwr(), p('trig', 'TRIG', 'right', 0.35, 'gpio'), p('echo', 'ECHO', 'right', 0.7, 'gpio')]),
  tof: part('tof', 'robotics', 'ToF sensor', 130, 70,
    'M3 5h4v6H3z M7 8h6 M10.5 5.5 13 8l-2.5 2.5',
    [...pwr(), p('i2c', 'I2C', 'right', 0.5, 'i2c')]),
  limitswitch: part('limitswitch', 'robotics', 'Limit switch', 120, 60,
    'M2 11h12 M4 11 10 5 M10.5 4.5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0-2 0 M4 11m-1 0a1 1 0 1 0 2 0a1 1 0 1 0-2 0',
    [p('out', 'OUT', 'right', 0.5, 'gpio')]),
  // Automotive
  vbat: part('vbat', 'automotive', 'Vehicle battery', 140, 70,
    'M2 5h12v8H2z M4 5V3.5h2.5V5 M9.5 5V3.5H12V5 M4 8.5h3 M5.5 7v3 M9 8.5h3',
    [p('out', 'OUT', 'right', 0.35, 'power'), p('gnd', 'GND', 'right', 0.7, 'gnd')]),
  fusebox: part('fusebox', 'automotive', 'Fuse box', 150, 80,
    'M2 3h12v10H2z M5.5 3v10 M9 3v10 M3.2 5.5h1 M6.7 5.5h1 M10.2 5.5h1 M3.2 8.5h1 M6.7 8.5h1 M10.2 8.5h1',
    [p('in', 'IN', 'left', 0.5, 'power'),
      p('out1', 'OUT1', 'right', 0.25, 'power'), p('out2', 'OUT2', 'right', 0.5, 'power'), p('out3', 'OUT3', 'right', 0.75, 'power')]),
  obd: part('obd', 'automotive', 'OBD-II port', 140, 70,
    'M2.5 5h11l-1.5 6h-8z M5 7h.01 M7 7h.01 M9 7h.01 M11 7h.01 M6 9h.01 M8 9h.01 M10 9h.01',
    [p('can', 'CAN', 'right', 0.5, 'can')]),
  lin: part('lin', 'automotive', 'LIN transceiver', 140, 70,
    'M1 8h5 M10 8h5 M6 5h4v6H6z',
    [...pwr('top'), p('mcu', 'UART', 'left', 0.5, 'uart'), p('bus', 'LIN', 'right', 0.5, 'gpio')]),
  hbridge: part('hbridge', 'automotive', 'H-bridge', 140, 75,
    'M4 3v10 M12 3v10 M4 8h8 M2 5h2 M2 11h2 M12 5h2 M12 11h2',
    [...pwr('top'), p('in1', 'IN1', 'left', 0.35, 'pwm'), p('in2', 'IN2', 'left', 0.7, 'pwm'), p('out', 'OUT', 'right', 0.5, 'power')]),
  wheelspeed: part('wheelspeed', 'automotive', 'Wheel speed', 140, 70,
    'M6 8m-4 0a4 4 0 1 0 8 0a4 4 0 1 0-8 0 M6 8m-1.2 0a1.2 1.2 0 1 0 2.4 0a1.2 1.2 0 1 0-2.4 0 M11 8h1l1-2 1 4 1-2',
    [...pwr(), p('out', 'OUT', 'right', 0.5, 'adc')]),
  // System & Cloud
